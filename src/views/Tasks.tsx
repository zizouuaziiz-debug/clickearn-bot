                ...
                <div className="flex items-start justify-between gap-3 mb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                      {category.provider === "cpx_research" ? "CPX Research survey wall with automatic wallet credit." : category.provider === "adgem" ? "AdGem offers and games with automatic wallet credit." : category.provider === "lootably" ? "Lootably offerwall with automatic wallet credit." : category.provider === "torox" ? "Torox offerwall with automatic wallet credit." : "Internal reward flow connected to your wallet."}
                    </p>
                  </div>
