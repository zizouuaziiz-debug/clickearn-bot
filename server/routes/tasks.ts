...
router.get("/", requireAuth, async (req, res) => {
  ...
  try {
    ...
    res.json({
      providerStatus: {
        cpxResearchEnabled: settings.cpxResearchEnabled,
      ...
      categories: [
        { id: "cpx-surveys", title: "CPX Research Surveys", type: "provider", provider: "cpx_research", route: "/surveys", enabled: settings.cpxResearchEnabled },
        ...
        { id: "lootably", title: "Lootably Offers", type: "provider", provider: "lootably", route: "/lootably", enabled: settings.lootablyEnabled },
        { id: "torox", title: "Torox Offers", type: "provider", provider: "torox", route: "/torox", enabled: settings.toroxEnabled },
