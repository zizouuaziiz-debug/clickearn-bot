...
export const adUnitsTable = pgTable("ad_units", {
  id: serial("id").primaryKey(),
  name: text("name").notNull(),
  provider: varchar("provider", { length: 20 }).notNull().default("adsgram"),
...
export const adminSettingsTable = pgTable("admin_settings", {
  ...
  brandingName: text("branding_name").notNull().default("Earnora"),
  ...
  // CPX Research
  cpxResearchEnabled: boolean("cpx_research_enabled").notNull().default(false),
  cpxResearchAppId: text("cpx_research_app_id").notNull().default(""),
  cpxResearchSecretKey: text("cpx_research_secret_key").notNull().default(""),
  cpxResearchRewardMultiplier: numeric("cpx_research_reward_multiplier", { precision: 8, scale: 4 }).notNull().default("1.0000"),
  // Lootably
  lootablyEnabled: boolean("lootably_enabled").notNull().default(false),
  lootablyPlacementId: text("lootably_placement_id").notNull().default(""),
  lootablySecretKey: text("lootably_secret_key").notNull().default(""),
  lootablyRewardMultiplier: numeric("lootably_reward_multiplier", { precision: 8, scale: 4 }).notNull().default("1.0000"),
  // Torox
  toroxEnabled: boolean("torox_enabled").notNull().default(false),
  toroxAppId: text("torox_app_id").notNull().default(""),
  toroxSecretKey: text("torox_secret_key").notNull().default(""),
  toroxRewardMultiplier: numeric("torox_reward_multiplier", { precision: 8, scale: 4 }).notNull().default("1.0000"),
  // Monetag
  monetagEnabled: boolean("monetag_enabled").notNull().default(false),
  monetagZoneId: text("monetag_zone_id").notNull().default(""),
  monetagRewardedReward: numeric("monetag_rewarded_reward", { precision: 12, scale: 4 }).notNull().default("0.0030"),
  monetagRewardedRevenue: numeric("monetag_rewarded_revenue", { precision: 12, scale: 4 }).notNull().default("0.0060"),
  // AdsGram
  adsgramEnabled: boolean("adsgram_enabled").notNull().default(false),
  adsgramBlockId: text("adsgram_block_id").notNull().default(""),
  adsgramRewardedReward: numeric("adsgram_rewarded_reward", { precision: 12, scale: 4 }).notNull().default("0.0050"),
  adsgramRewardedRevenue: numeric("adsgram_rewarded_revenue", { precision: 12, scale: 4 }).notNull().default("0.0100"),
