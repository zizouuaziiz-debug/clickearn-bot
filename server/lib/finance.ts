...
export async function creditRewardWithVip(params: {
  ...
  const run = async (executor: any) => {
    ...
    const rewardTypeMap: Record<string, { type: string; category: string }> = {
      ...
      survey_reward: { type: "survey_reward", category: "survey_reward" },
      cpx_research_survey: { type: "cpx_research_survey", category: "survey_reward" },
      cpx_research_offer: { type: "cpx_research_offer", category: "offer_reward" },
      lootably_offer: { type: "lootably_offer", category: "offer_reward" },
      torox_offer: { type: "torox_offer", category: "offer_reward" },
    };
