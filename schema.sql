-- Earnora Telegram Mini App schema
...
CREATE TABLE IF NOT EXISTS ad_units (
  id SERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  provider VARCHAR(20) NOT NULL DEFAULT 'adsgram',
...
CREATE TABLE IF NOT EXISTS admin_settings (
  ...
  branding_name TEXT NOT NULL DEFAULT 'Earnora',
  ...
  cpx_research_enabled BOOLEAN NOT NULL DEFAULT false,
  cpx_research_app_id TEXT NOT NULL DEFAULT '',
  cpx_research_secret_key TEXT NOT NULL DEFAULT '',
  cpx_research_reward_multiplier NUMERIC(8, 4) NOT NULL DEFAULT 1.0000,
  -- Lootably
  lootably_enabled BOOLEAN NOT NULL DEFAULT false,
  lootably_placement_id TEXT NOT NULL DEFAULT '',
  lootably_secret_key TEXT NOT NULL DEFAULT '',
  lootably_reward_multiplier NUMERIC(8, 4) NOT NULL DEFAULT 1.0000,
  -- Torox
  torox_enabled BOOLEAN NOT NULL DEFAULT false,
  torox_app_id TEXT NOT NULL DEFAULT '',
  torox_secret_key TEXT NOT NULL DEFAULT '',
  torox_reward_multiplier NUMERIC(8, 4) NOT NULL DEFAULT 1.0000,
  -- Monetag
  monetag_enabled BOOLEAN NOT NULL DEFAULT false,
  monetag_zone_id TEXT NOT NULL DEFAULT '',
  monetag_rewarded_reward NUMERIC(12, 4) NOT NULL DEFAULT 0.0030,
  monetag_rewarded_revenue NUMERIC(12, 4) NOT NULL DEFAULT 0.0060,
  -- AdsGram
  adsgram_enabled BOOLEAN NOT NULL DEFAULT false,
  adsgram_block_id TEXT NOT NULL DEFAULT '',
  adsgram_rewarded_reward NUMERIC(12, 4) NOT NULL DEFAULT 0.0050,
  adsgram_rewarded_revenue NUMERIC(12, 4) NOT NULL DEFAULT 0.0100,
...
-- AdsGram default ad unit (replace adsgram_default with your real Block ID from AdsGram dashboard)
INSERT INTO ad_units (name, provider, ad_type, unit_key, placement, reward, revenue_per_view, is_active) VALUES
  ('AdsGram Rewarded Ad', 'adsgram', 'rewarded', 'adsgram_default', 'ads_wall', 0.0050, 0.0100, true)
